...
return this.request(u(r || {}, {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            return new Promise(function(t, n) {
                ...
                if (l.open(e.method.toUpperCase(), s(y, e.params, e.paramsSerializer), !0),
                l.timeout = e.timeout,
    ...
    , function(e, t, n) {
        "use strict";
        var r = n(2)
          , o = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referera", "retry-after", "user-agent"];
        e.exports = function(e) {
            var t, n, i, s = {};
